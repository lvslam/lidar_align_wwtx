...
double Aligner::LidarOdomMinimizer(const std::vector<double> &x,
    ...
    if (x.size() > 3) {
        std::cout << " \033[1mx:\033[0m " << std::setw(6) << vec[0];
        std::cout << " \033[1my:\033[0m " << std::setw(6) << vec[1];
        std::cout << " \033[1mz:\033[0m " << std::setw(6) << vec[2];
    }
    std::cout << " \033[1mrx:\033[0m " << std::setw(6) << vec[3];
    std::cout << " \033[1mry:\033[0m " << std::setw(6) << vec[4];
    std::cout << " \033[1mrz:\033[0m " << std::setw(6) << vec[5];
    if (x.size() > 6) {
        std::cout << " \033[1mtime:\033[0m " << std::setw(6) << x[6];
    }
    std::cout << " \033[1mError:\033[0m " << std::setw(10) << error;
    std::cout << " \033[1mIteration:\033[0m " << i++ << '\r' << std::flush;
...
void Aligner::lidarOdomTransform(Lidar *lidar, Odom *odom) {
    ...
    ROS_INFO("\033[1mFinal Calibration:\033[0m                                ");
